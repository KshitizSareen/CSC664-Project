...
cap = cv2.VideoCapture("TestVideo1.mov")
_,frame=cap.read()
...
cv2.setMouseCallback('imageFrame',selectPoint)


while 1:
    for point in points:
        cv2.circle(frame,(int(point[0]),int(point[1])),5,(0,0,255),2)
